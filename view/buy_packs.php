...
<div class="relative w-[50%]  flex flex-col mx-auto items-center justify-center">
    ...
    <a href="../controller/buypacks.php?type=gold"  class="hidden group-hover:flex bg-black/80 text-white rounded-xl justify-center items-center transition absolute w-full h-full duration-150 ease-in-out mx-auto mb-4">Acheter</a>   <!-- Nouveau bouton ajouté -->
</div>
<p>4000 crédits <br> 23 joueurs</p>
</div>

<div class="relative w-[50%]  flex flex-col mx-auto items-center justify-center">
     <div class="group bg-gradient-to-b h-[80%] from-slate-100 to-slate-200 rounded-xl relative drop-shadow transition duration-150 ease-in-out w-[30%] my-8 flex flex-col text-center align-center">
    <img class="my-2" src="images/silver.png" alt="Silver Pack">
    <a href="../controller/buypacks.php?type=silver"  class="hidden group-hover:flex bg-black/80 text-white rounded-xl justify-center items-center transition absolute w-full h-full duration-150 ease-in-out mx-auto mb-4">Acheter</a>   <!-- Nouveau bouton ajouté -->
</div>
<p>2000 crédits <br> 11 joueurs</p>
</div>

<div class="relative w-[50%]  flex flex-col mx-auto items-center justify-center">
     <div class="group bg-gradient-to-b h-[80%] from-slate-100 to-slate-200 rounded-xl relative drop-shadow transition duration-150 ease-in-out w-[30%] my-8 flex flex-col text-center align-center">
    <img class="my-2" src="images/bronze.png" alt="Bronze Pack">
    <a href="../controller/buypacks.php?type=bronze"  class="hidden group-hover:flex bg-black/80 text-white rounded-xl justify-center items-center transition absolute w-full h-full duration-150 ease-in-out mx-auto mb-4">Acheter</a>   <!-- Nouveau bouton ajouté -->
</div>
<p>1000 crédits <br> 5 joueurs</p>
</div>
