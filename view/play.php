...
<div class="logo-container mx-auto relative flex flex-col justify-center items-center">
 ...
 <div class=" bg-slate-100/80 rounded-lg flex items-center justify center mt-12 w-[80%] mx-auto">
    <div class="relative w-[50%] flex align-center justify-center">
         <div class="group  rounded-xl relative drop-shadow transition duration-150 ease-in-out w-[30%] my-8 flex flex-col text-center align-center">
<a id="myteambtn" href="myteam.php"  class="hover:scale-105">
            <img class=""src="images/myteam.png" alt="logo">
            </a>
</div>
</div>
<div class="relative w-[50%] flex align-center justify-center">
         <div class="group rounded-xl relative drop-shadow transition duration-150 ease-in-out w-[30%] my-8 flex flex-col text-center align-center">
<a id="versusbtn" href="versus.php" class="hover:scale-105">
            <img class=""src="images/versus.png" alt="logo">
            </a>
</div>
</div>
</div>
