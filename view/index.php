...
<div class="logo-container mx-auto relative flex flex-col justify-center items-center">
    ...
    <div class="playcontainer flex w-full justify-center items-center">
       <a href="play.php" class="button playbtn mx-auto p-1 px-2 bg-red-500 hover:scale-105 hover:bg-red-700 transition duration-150">play</a>   <!-- Nouveau bouton ajouté -->
       </div>
 <div class=" bg-slate-100/80 rounded-lg flex items-center justify center mt-12 w-[80%] mx-auto">
    <div class="relative w-[50%] flex align-center justify-center">
         <div class="group bg-gradient-to-b from-slate-100 to-slate-200 rounded-xl relative drop-shadow transition duration-150 ease-in-out w-[30%] my-8 flex flex-col text-center align-center">
    <img class="" src="images/packs.png" alt="Packs">
    <a href="packs_page.php" class="hidden group-hover:flex bg-black/80 text-white rounded-xl justify-center items-center transition absolute w-full h-full duration-150 ease-in-out mx-auto mb-4">Mes Packs</a>   <!-- Nouveau bouton ajouté -->
</div>
</div>
...
<div class="relative w-[50%] flex align-center justify-center">
         <div class="group bg-gradient-to-b from-slate-100 to-slate-200 rounded-xl relative drop-shadow transition duration-150 ease-in-out w-[30%] my-8 flex flex-col text-center align-center">
    <img class="" src="images/players.png" alt="Players">
    <a href="player_list.php"  class="hidden group-hover:flex bg-black/80 text-white rounded-xl justify-center items-center transition absolute w-full h-full duration-150 ease-in-out mx-auto mb-4">Mes Joueurs</a>   <!-- Nouveau bouton ajouté -->
</div>
